...
class ActionBookRecommendation(Action):
    ...
    def fetch_recommendations_by_title(self, title: Text) -> List[Text]:
        books = pd.read_csv("/home/hari/Documents/MLAI/Testing/Project Testing/Rasa2/Readflix/actions/book_reco.csv")
...
class ActionMovieRecommendation(Action):
    ...
    def fetch_recommendations_by_title(self, title: Text) -> List[Text]:
        movies = pd.read_csv("/home/hari/Documents/MLAI/Testing/Project Testing/Rasa2/Readflix/actions/movie_reco.csv")
